      ...
      <div className="max-w-7xl mx-auto px-6 py-10 ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
           ...
           {/* <Logo /> */}
              <h2 className="text-xl font-semibold text-white">Amader Doctor</h2>
            </div>
            <p className="text-sm leading-relaxed text-gray-400">
              Amader Doctor is a digital healthcare platform connecting patients with verified doctors for secure, reliable, and convenient medical consultations anytime, anywhere.
            </p>
          </div>
